  ...
  return (
    <>
      <footer className="bg-gray-900">
        <div className="bg-gray-900 w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
          <div className="text-center">
            <div>
              <a
                className="flex-none text-xl font-semibold text-white dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="#"
                aria-label="Brand"
              >
            ...
            <div className="mt-3">
              ...
              <p className="text-gray-500">© CVSW2023. All rights reserved.</p>
            </div>
