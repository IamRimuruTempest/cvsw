    ...
    <div className="bg-[linear-gradient(248deg,_rgba(185,_34,_46,_1)_0%,_rgba(1,_9,_79,_1)_50%,_rgba(244,_197,_66,_1)_100%)] bg-cover">
      <div className="max-w-[70rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto grid content-center">
        ...
        <div className="mt-3">
          ...
          >
            {DAY1.map((dayone) => (
              <div className={`group mb-3 flex flex-col bg-[${dayone.bg}] border shadow-sm  hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600`}>
